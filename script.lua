...
local function IWDBELV_fake_script() -- X.Close 
...
coroutine.wrap(IWDBELV_fake_script)()
local function TOHD_fake_script() -- Switch.SpeedBoost 
...
coroutine.wrap(TOHD_fake_script)()
local function MUELBZ_fake_script() -- LocalPlayer_2.Switch 
...
coroutine.wrap(MUELBZ_fake_script)()
local function IZISD_fake_script() -- Home_2.Switch 
...
coroutine.wrap(IZISD_fake_script)()
